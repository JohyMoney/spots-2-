...
api.getAppInfo()
  .then(([userInfo, cards]) => {
    userInfoSection.setUserInfo(userInfo);
...
api.getInitialCards()
  .then((cards) => {
    cards.forEach((cardData) => {
      const cardElement = getCardElement(cardData, handleDeleteCard);
...
function getCardElement(data, handleDeleteCard) {
  ...
  cardDeleteBtn.addEventListener("click", (evt) => {
    ...
    return handleDeleteCard(cardElement, data._id);
  });
